...
- RGridError (base class)
  ...
  - QuotaExceededError: Quota/rate limit exceeded
"""
...
class AuthenticationError(RGridError):
    ...
    suggestions = [
        ...
        "Run 'rgrid init' to authenticate",
...
class ResourceNotFoundError(RGridError):
    ...
    suggestions = [
        ...
        "Use 'rgrid status' to see your executions"
    ]
